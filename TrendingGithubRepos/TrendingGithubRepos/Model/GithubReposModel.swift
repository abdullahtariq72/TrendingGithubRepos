...
// MARK: - GithubReposListModel
class GithubReposListModel: Codable {
    let totalCount: Int
...
class License: Codable {
    ...
    init(key: Key?, name: Name?, spdxID: SpdxID?, url: String?, nodeID: NodeID?) {
        self.key = key
        self.name = name
        self.spdxID = spdxID
        self.url = url
